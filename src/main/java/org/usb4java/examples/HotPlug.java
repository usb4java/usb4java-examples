...
{
    /**
     * This is the event handling thread. libusb doesn't start threads by
     * its own so it is our own responsibility to give libusb time to handle
     * the events in our own thread.
     */
    static class EventHandlingThread extends Thread
    {
        ...
        public void run()
        {
            while (!this.abort)
            {
                // This call blocks until libusb has handled at least one
                // event or a hotplug callback has been deregistered 
